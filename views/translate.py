from tkinter import Canvas, PhotoImage, Button, Frame, StringVar, Text, Label
...
class TranslateView(Frame):
    def __init__(self, master):
        ...
        self.canvas.create_rectangle(90.0, 354.0, 934.0, 648.0, fill="#191919", outline="")
        self.canvas.create_rectangle(89.0, 646.9998177080748, 934.0, 648.0, fill="#F58B57", outline="")
        ...
        self.canvas.create_rectangle(684.0, 51.0, 934.0, 101.0, fill="#191919", outline="")
